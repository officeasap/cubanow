      ...
      <div className="relative bg-gradient-to-br from-gray-50 to-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            <Card className="overflow-hidden hover:scale-105 transition-transform duration-300 animate-bounce-subtle bg-white" style={{ borderRadius: '16px', boxShadow: '0 12px 20px rgba(39, 39, 39, 0.4), 0 16px 32px rgba(39, 39, 39, 0.2)' }}>
              ...
              <div className="p-8">
                ...
                <Link to="/book-consultation">
                  <Button className="bg-[#28A030] hover:bg-[#1e8026] text-white px-6 py-3 font-medium transition-all duration-200" style={{ borderRadius: '16px' }}>Register</Button>
                </Link>
              </div>
            </Card>
            ...
            {/* New Cards */}
            <Card className="overflow-hidden hover:scale-105 transition-transform duration-300 animate-bounce-subtle bg-white" style={{ borderRadius: '16px', boxShadow: '0 12px 20px rgba(39, 39, 39, 0.4), 0 16px 32px rgba(39, 39, 39, 0.2)' }}>
              <img src="/images/CubaAdventurers2025.png" alt="Cuba Adventurers" className="w-full h-79 object-cover" />
              <div className="p-8">
                <h3 className="text-2xl font-bold text-[#222222] mb-4">Cuba Adventurers 2025</h3>
                <p className="text-[#717171] mb-2">Mon, Jul 7</p>
                <p className="text-[#717171] mb-4">Havana</p>
                <p className="text-[#717171] mb-6">All-inclusive cultural & academic experience</p>
                <Link to="/book-consultation">
                  <Button className="bg-[#28A030] hover:bg-[#1e8026] text-white px-6 py-3 font-medium transition-all duration-200" style={{ borderRadius: '16px' }}>Register</Button>
                </Link>
              </div>
            ...
            <Card className="overflow-hidden hover:scale-105 transition-transform duration-300 animate-bounce-subtle bg-white" style={{ borderRadius: '16px', boxShadow: '0 12px 20px rgba(39, 39, 39, 0.4), 0 16px 32px rgba(39, 39, 39, 0.2)' }}>
              <img src="/images/LeadershipFrontlines.png" alt="Leadership Frontlines" className="w-full h-79 object-cover" />
              <div className="p-8">
                <h3 className="text-2xl font-bold text-[#222222] mb-4">Leadership Frontlines</h3>
                <p className="text-[#717171] mb-2">Mon, Jul 14</p>
                <p className="text-[#717171] mb-4">Camagüey</p>
                <p className="text-[#717171] mb-6">Elite teen leadership in action & innovation</p>
                <Link to="/book-consultation">
                  <Button className="bg-[#28A030] hover:bg-[#1e8026] text-white px-6 py-3 font-medium transition-all duration-200" style={{ borderRadius: '16px' }}>Register</Button>
                </Link>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            <Card className="overflow-hidden hover:scale-105 transition-transform duration-300 animate-bounce-subtle bg-white" style={{ borderRadius: '16px', boxShadow: '0 12px 20px rgba(39, 39, 39, 0.4), 0 16px 32px rgba(39, 39, 39, 0.2)' }}>
              <img src="/images/Dr,RobertClyne.png" alt="Cuba landscape" className="w-full h-full object-cover" />
            </Card>
          </div>
          ...
          <div className="mb-16">
            <Card className="p-8 hover:scale-105 transition-transform duration-300 animate-bounce-subtle bg-white" style={{ borderRadius: '16px', boxShadow: '0 12px 20px rgba(39, 39, 39, 0.4), 0 16px 32px rgba(39, 39, 39, 0.2)' }}>
              ...
              <div className="text-[#717171] leading-relaxed space-y-4" style={{
